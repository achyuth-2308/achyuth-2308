...
- Multi-agent GenAI PoCs
- ML pipelines and analytical engines
- Automated workflows with DevOps

### 🧠 Tech Stack
`Python` `C++` `React` `Flask` `LangChain` `LangGraph` `Playwright` `Azure` `MySQL` `ESP32` `Arduino`
